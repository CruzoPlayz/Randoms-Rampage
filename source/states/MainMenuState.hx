...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("WELCOME TO MY WORLD", null);
		#end
	...
	function changeItem(huh:Int = 0)
	{
		...
		menuItems.members[curSelected].setPosition(-2000,-2000000);
		curSelected += huh;
		...
		menuItems.members[curSelected].screenCenter(XY);
